...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <label for = "create_post">Enter a Title</label>
            <input class="form-control" name="Post Title" size="30" placeholder="Post Title" />
            <label for = "content">Input the Content of the Post</label>
            <input class="form-control" name="Post Content" size="30" placeholder="Post Content" />
        </div>
    </div>
