    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="create_post" method="post">
                ...
                <textarea class="form-control" name="content" size="30" placeholder="Comment Content"></textarea>

                <input type="hidden" name="author" value="${user.username}">
                <input type="hidden" name="hostThread" value="${currentThread.id}">

                <p class="text-warning">${message}</p><br>
                <button type="submit" class="btn btn-dark" onclick="">Comment</button>
            </form>
        </div>
    </div>
